...
public class TestDumper {
	...
	public String testfile="/home/lpxz/eclipse/workspace/Playground/src/Toy.java";
    @Test
    public void testDumpVisitor() throws Exception {
        //String source = Helper.readClass(testDir, Toy.class);
       ...
       // assertEquals(source, cu.toString());
        for(Object coment : cu.getComments())
        {
