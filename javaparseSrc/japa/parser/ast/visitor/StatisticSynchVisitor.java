...
public  class StatisticSynchVisitor extends DumpVisitor
{
	
	public  List classesOrInterfaces = new ArrayList<String>();
	public String packageName ="";
	public static int fieldNum=0;
	public static int methodNum=0;
	public static int classNum=0;
	public static HashSet syncBlocks = new HashSet();
 	public static int syncMethodNum =0;
...
//	    			}
	    ...
	    public void visit(ClassOrInterfaceDeclaration n, Object arg) {
	        ...
	        printMemberAnnotations(n.getAnnotations(), arg);
	        printModifiers(n.getModifiers());
	        String packagePrefixString = (packageName.equals("")?"":packageName+".");
	        classesOrInterfaces.add(packagePrefixString+n.getName());
	        if (n.isInterface()) {
	        ...
	        if (n.getMembers() != null) {
	            ...
	            {
	            	if(bd instanceof ConstructorDeclaration || bd instanceof MethodDeclaration)
	            	{
	            		methodNum ++;
	            	}
