 ...
 *                   Christian Hammer
 *
 * $Id: ConnectivityInspector.java,v 1.1 2009/10/22 15:09:35 charlesz Exp $
 *
 * Changes
 * -------
    ...
    implements GraphListener<V, E>
{
    ...
    public List<Set<V>> lazyFindConnectedSets()
    {
        ...
        extends TraversalListenerAdapter<V, E>
    {
        ...
        {
            V v = e.getVertex();
            currentConnectedSet.add(v);//set.add(V)
            vertexToConnectedSet.put(v, currentConnectedSet);// v-> set
        }
    }
}
