 ...
 
{
    ...
    {
    	Pseudograph<Object, DefaultEdge> test = new Pseudograph<Object, DefaultEdge>(DefaultEdge.class);
        test.addVertex("node1");
        test.addVertex("node2");
        test.addEdge("node1","node2");
        test.addVertex("node3");
        test.addVertex("node4");
        test.addEdge("node3","node4");
        
        List comps  = test.weaklyConnectedComponents();
        System.out.println("post_debug");
    }
}
