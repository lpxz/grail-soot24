...
//        }
    ...
    {
    	String postfix = "";
    	if(v instanceof JoinThreadEvent) postfix = "join";
    	else if (v instanceof LockingEvent) postfix = "lock";
    	else if (v instanceof NotifyingEvent) postfix ="noti";
    	else if (v instanceof SharedAccessEvent) postfix ="shac";
    	else if (v instanceof StartThreadEvent) postfix ="start";
    	else if (v instanceof ThreadBeginEvent) postfix ="tbeg";
    	else if (v instanceof ThreadEndEvent) postfix ="tend";
    	else if (v instanceof UnlockingEvent) postfix ="unlo";
    	else if (v instanceof WaitingEvent) postfix ="wait";
    	return "\"" +v.hashCode() + postfix + "\"";
    }
    public void export4CausalGraph(Writer writer, Graph<V, E> g)
    {
        ...
        for (E e : g.edgeSet()) {
        	...
        	String color ="black";
        	String label = "";
        	if(e instanceof CommunicationCausalEdge)
        	{
        		color ="red";
        		label= "COMM";
        	}
        	if(e instanceof LockingCausalEdge)
        	{
        		color ="purple";
        		label= "LOCK";
        	}
        	
        	if(e instanceof SharedAccessCausalEdge)
        	{
        		color = "green";
        		label= "SHAC";
        	}
