...
public final class Qobj_typeBDD extends Qobj_type {
    public Qobj_typeBDD(String name) {
        super(name);
    }
    ...
    public void add(AllocNode _obj,
                    Type _type) {
        add(new jedd.internal.RelationContainer(new Attribute[] { A_obj.v(), A_type.v() },
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it =
            ...
            Robj_typeBDD reader =
              (Robj_typeBDD)
                it.next();
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { A_type.v(), A_obj.v() },
                                                           new PhysicalDomain[] { T1.v(), H1.v() },
                                                           "reader.add(in) at Qobj_typeBDD.jedd:40,12-18",
                                                           in));
        }
    }
