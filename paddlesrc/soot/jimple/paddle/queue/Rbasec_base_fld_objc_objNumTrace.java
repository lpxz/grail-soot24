...
public class Rbasec_base_fld_objc_objNumTrace extends Rbasec_base_fld_objc_obj {
    public Rbasec_base_fld_objc_objNumTrace(String name, PaddleQueue q) { super(name, q); }
