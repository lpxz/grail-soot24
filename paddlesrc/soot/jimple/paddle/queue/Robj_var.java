...
public abstract class Robj_var implements PaddleQueueReader {
    public Robj_var(String name, PaddleQueue q) { super();
                                                  this.name = name;
                                                  this.q = q;
                                                  Readers.v().add(this); }
    ...
    public static class Tuple {
        ...
        public Tuple(AllocNode _obj, VarNode _var) { super();
                                                     this._obj = _obj;
                                                     this._var = _var; }
