...
public class Rvarc_var_objc_obj_srcm_stmt_kind_tgtmSet extends Rvarc_var_objc_obj_srcm_stmt_kind_tgtm {
    public Rvarc_var_objc_obj_srcm_stmt_kind_tgtmSet(String name, PaddleQueue q) { super(name, q); }
