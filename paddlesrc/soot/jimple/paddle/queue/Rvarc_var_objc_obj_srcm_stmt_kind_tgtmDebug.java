...
public class Rvarc_var_objc_obj_srcm_stmt_kind_tgtmDebug extends Rvarc_var_objc_obj_srcm_stmt_kind_tgtm {
    protected Rvarc_var_objc_obj_srcm_stmt_kind_tgtmBDD bdd;
    
    protected Rvarc_var_objc_obj_srcm_stmt_kind_tgtmSet trad;
    
    public Rvarc_var_objc_obj_srcm_stmt_kind_tgtmDebug(Rvarc_var_objc_obj_srcm_stmt_kind_tgtmBDD bdd,
                                                       Rvarc_var_objc_obj_srcm_stmt_kind_tgtmSet trad, String name,
                                                       PaddleQueue q) {
        super(name, q);
        this.bdd = bdd;
        this.trad = trad;
