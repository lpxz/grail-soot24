...
public class Qobj_typeDebug extends Qobj_type {
    public Qobj_typeDebug(String name) {
        super(name);
    }
    
    private Qobj_typeBDD bdd =
      new Qobj_typeBDD(name +
                       "bdd");
    
    private Qobj_typeSet trad =
      new Qobj_typeSet(name +
                       "set");
    ...
    public void add(final jedd.internal.RelationContainer in) {
        Iterator it =
          new jedd.internal.RelationContainer(new Attribute[] { A_type.v(), A_obj.v() },
                                              ...
                                              ("in.iterator(new jedd.Attribute[...]) at Qobj_typeDebug.jedd:" +
                                               "40,22-24"),
    ...
    public Robj_type reader(String rname) {
        return new Robj_typeDebug((Robj_typeBDD)
                                    bdd.reader(rname),
                                  (Robj_typeSet)
                                    trad.reader(rname),
                                  name +
