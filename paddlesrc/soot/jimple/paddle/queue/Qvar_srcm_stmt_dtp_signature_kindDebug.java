...
public class Qvar_srcm_stmt_dtp_signature_kindDebug extends Qvar_srcm_stmt_dtp_signature_kind {
    public Qvar_srcm_stmt_dtp_signature_kindDebug(String name) {
        super(name);
    }
    
    private Qvar_srcm_stmt_dtp_signature_kindBDD bdd =
      new Qvar_srcm_stmt_dtp_signature_kindBDD(name +
                                               "bdd");
    
    private Qvar_srcm_stmt_dtp_signature_kindSet trad =
      new Qvar_srcm_stmt_dtp_signature_kindSet(name +
                                               "set");
        ...
        Iterator it =
          new jedd.internal.RelationContainer(new Attribute[] { A_kind.v(), A_var.v(), A_srcm.v(), A_dtp.v(), A_signature.v(), A_stmt.v() },
                                              ...
                                              ("in.iterator(new jedd.Attribute[...]) at Qvar_srcm_stmt_dtp_s" +
                                               "ignature_kindDebug.jedd:40,22-24"),
    ...
    public Rvar_srcm_stmt_dtp_signature_kind reader(String rname) {
        return new Rvar_srcm_stmt_dtp_signature_kindDebug((Rvar_srcm_stmt_dtp_signature_kindBDD)
                                                            bdd.reader(rname),
                                                          (Rvar_srcm_stmt_dtp_signature_kindSet)
                                                            trad.reader(rname),
                                                          name +
                                                          ":" +
                                                          rname,
