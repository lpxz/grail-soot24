...
public final class QobjBDD extends Qobj {
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) {
            ...
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { A_obj.v() },
                                                           new PhysicalDomain[] { H1.v() },
                                                           "reader.add(in) at QobjBDD.jedd:40,12-18", in));
        }
    }
    
    public Robj reader(String rname) { Robj ret = new RobjBDD(name + ":" + rname, this);
                                       readers.add(ret);
                                       return ret; }
}
