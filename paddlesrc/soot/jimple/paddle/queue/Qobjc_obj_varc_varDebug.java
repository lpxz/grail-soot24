...
public class Qobjc_obj_varc_varDebug extends Qobjc_obj_varc_var {
    public Qobjc_obj_varc_varDebug(String name) {
        super(name);
    }
    
    private Qobjc_obj_varc_varBDD bdd =
      new Qobjc_obj_varc_varBDD(name +
                                "bdd");
    
    private Qobjc_obj_varc_varSet trad =
      new Qobjc_obj_varc_varSet(name +
                                "set");
    ...
    public void add(final jedd.internal.RelationContainer in) {
        Iterator it =
          new jedd.internal.RelationContainer(new Attribute[] { A_var.v(), A_obj.v(), A_varc.v(), A_objc.v() },
                                              ...
                                              ("in.iterator(new jedd.Attribute[...]) at Qobjc_obj_varc_varDe" +
                                               "bug.jedd:40,22-24"),
    ...
    public Robjc_obj_varc_var reader(String rname) {
        return new Robjc_obj_varc_varDebug((Robjc_obj_varc_varBDD)
                                             bdd.reader(rname),
                                           (Robjc_obj_varc_varSet)
                                             trad.reader(rname),
                                           name +
                                           ":" +
                                           rname,
