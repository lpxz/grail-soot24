...
public final class Qobj_varNumTrace extends Qobj_var {
    ...
    public void add(AllocNode _obj, VarNode _var) {
        ...
        for (Iterator it = readers.iterator(); it.hasNext(); ) { Robj_varNumTrace reader = (Robj_varNumTrace) it.next();
                                                                 reader.add(in); } }
    
    public void add(final jedd.internal.RelationContainer in) { throw new RuntimeException(); }
    
    public Robj_var reader(String rname) { Robj_var ret = new Robj_varNumTrace(name + ":" + rname, this);
                                           readers.add(ret);
                                           return ret; }
}
