...
public final class Rsrcm_stmt_kind_tgtm_src_dstMerge extends Rsrcm_stmt_kind_tgtm_src_dst {
    ...
    public Rsrcm_stmt_kind_tgtm_src_dstMerge(Rsrcm_stmt_kind_tgtm_src_dst in1,
                                             Rsrcm_stmt_kind_tgtm_src_dst in2) {
        super(in1.name +
              "+" +
              in2.name,
              null);
    ...
    public jedd.internal.RelationContainer get() {
        return new jedd.internal.RelationContainer(new Attribute[] { A_kind.v(), A_srcm.v(), A_tgtm.v(), A_src.v(), A_dst.v(), A_stmt.v() },
                                                   ...
                                                   ("return jedd.internal.Jedd.v().union(jedd.internal.Jedd.v().r" +
                                                    "ead(in1.get()), in2.get()); at Rsrcm_stmt_kind_tgtm_src_dstM" +
                                                    "erge.jedd:52,8-14"),
