...
public final class Qsrcc_src_dstc_dstBDD extends Qsrcc_src_dstc_dst {
    public Qsrcc_src_dstc_dstBDD(String name) {
        super(name);
    }
    ...
    public void add(Context _srcc,
                    ...
                    Context _dstc,
                    VarNode _dst) {
        add(new jedd.internal.RelationContainer(new Attribute[] { A_srcc.v(), A_src.v(), A_dstc.v(), A_dst.v() },
    ...
    public void add(final jedd.internal.RelationContainer in) {
        ...
        for (Iterator it =
            ...
            Rsrcc_src_dstc_dstBDD reader =
              (Rsrcc_src_dstc_dstBDD)
                it.next();
            reader.add(new jedd.internal.RelationContainer(new Attribute[] { A_srcc.v(), A_dstc.v(), A_src.v(), A_dst.v() },
                                                           new PhysicalDomain[] { C1.v(), C2.v(), V1.v(), V2.v() },
                                                           "reader.add(in) at Qsrcc_src_dstc_dstBDD.jedd:40,12-18",
                                                           in));
        }
    }
    
    public Rsrcc_src_dstc_dst reader(String rname) {
        Rsrcc_src_dstc_dst ret =
          new Rsrcc_src_dstc_dstBDD(name +
                                    ":" +
                                    rname,
                                    this);
        readers.add(ret);
