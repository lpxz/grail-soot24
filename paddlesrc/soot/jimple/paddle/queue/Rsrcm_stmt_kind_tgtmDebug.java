...
public class Rsrcm_stmt_kind_tgtmDebug extends Rsrcm_stmt_kind_tgtm {
    protected Rsrcm_stmt_kind_tgtmBDD bdd;
    
    protected Rsrcm_stmt_kind_tgtmSet trad;
    
    public Rsrcm_stmt_kind_tgtmDebug(Rsrcm_stmt_kind_tgtmBDD bdd, Rsrcm_stmt_kind_tgtmSet trad, String name,
                                     PaddleQueue q) {
        super(name, q);
        this.bdd = bdd;
        this.trad = trad;
