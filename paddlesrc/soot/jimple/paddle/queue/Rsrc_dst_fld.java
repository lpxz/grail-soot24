...
public abstract class Rsrc_dst_fld implements PaddleQueueReader {
    public Rsrc_dst_fld(String name, PaddleQueue q) { super();
                                                      this.name = name;
                                                      this.q = q;
                                                      Readers.v().add(this); }
    ...
    public static class Tuple {
        ...
        public Tuple(VarNode _src, VarNode _dst, PaddleField _fld) { super();
                                                                     this._src = _src;
                                                                     this._dst = _dst;
                                                                     this._fld = _fld; }
