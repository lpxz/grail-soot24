...
public abstract class Rsrcc_src_dstc_dst_fld implements PaddleQueueReader {
    public Rsrcc_src_dstc_dst_fld(String name, PaddleQueue q) { super();
                                                                this.name = name;
                                                                this.q = q;
                                                                Readers.v().add(this); }
    ...
    public static class Tuple {
        ...
        public Tuple(Context _srcc, VarNode _src, Context _dstc, VarNode _dst, PaddleField _fld) { super();
                                                                                                   this._srcc = _srcc;
                                                                                                   this._src = _src;
                                                                                                   this._dstc = _dstc;
                                                                                                   this._dst = _dst;
