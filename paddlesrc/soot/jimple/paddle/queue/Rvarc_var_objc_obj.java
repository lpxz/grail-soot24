...
public abstract class Rvarc_var_objc_obj implements PaddleQueueReader {
    public Rvarc_var_objc_obj(String name, PaddleQueue q) { super();
                                                            this.name = name;
                                                            this.q = q;
                                                            Readers.v().add(this); }
    ...
    public static class Tuple {
        ...
        public Tuple(Context _varc, VarNode _var, Context _objc, AllocNode _obj) { super();
                                                                                   this._varc = _varc;
                                                                                   this._var = _var;
                                                                                   this._objc = _objc;
                                                                                   this._obj = _obj; }
