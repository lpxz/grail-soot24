...
public final class Rvar_method_typeMerge extends Rvar_method_type {
    ...
    public Rvar_method_typeMerge(Rvar_method_type in1, Rvar_method_type in2) { super(in1.name + "+" + in2.name, null);
                                                                               this.in1 = in1;
                                                                               this.in2 = in2; }
    ...
    public jedd.internal.RelationContainer get() {
        return new jedd.internal.RelationContainer(new Attribute[] { A_type.v(), A_var.v(), A_method.v() },
                                                   ...
                                                   ("return jedd.internal.Jedd.v().union(jedd.internal.Jedd.v().r" +
                                                    "ead(in1.get()), in2.get()); at Rvar_method_typeMerge.jedd:52" +
                                                    ",8-14"),
