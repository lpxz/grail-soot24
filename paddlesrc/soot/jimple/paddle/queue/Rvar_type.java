...
public abstract class Rvar_type implements PaddleQueueReader {
    public Rvar_type(String name, PaddleQueue q) { super();
                                                   this.name = name;
                                                   this.q = q;
                                                   Readers.v().add(this); }
    ...
    public static class Tuple {
        ...
        public Tuple(VarNode _var, Type _type) { super();
                                                 this._var = _var;
                                                 this._type = _type; }
