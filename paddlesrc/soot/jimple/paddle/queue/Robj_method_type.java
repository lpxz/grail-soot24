...
public abstract class Robj_method_type implements PaddleQueueReader {
    public Robj_method_type(String name, PaddleQueue q) { super();
                                                          this.name = name;
                                                          this.q = q;
                                                          Readers.v().add(this); }
    ...
    public static class Tuple {
        ...
        public Tuple(AllocNode _obj, SootMethod _method, Type _type) { super();
                                                                       this._obj = _obj;
