...
public class BDDReader implements Cloneable {
    ...
    public jedd.internal.RelationContainer next() {
        final jedd.internal.RelationContainer ret =
          new jedd.internal.RelationContainer(new jedd.Attribute[] {  }, new jedd.PhysicalDomain[] {  },
                                              "<> ret; at BDDReader.jedd:41,11-14");
        do  {
            ret.eq(chunk.bdd);
            chunk = chunk.next;
            if (chunk == null) chunk = q.newChunk();
                 ...
                 chunk.next != null); 
        return new jedd.internal.RelationContainer(new jedd.Attribute[] {  }, new jedd.PhysicalDomain[] {  },
                                                   "return ret; at BDDReader.jedd:47,8-14", ret);
    }
    ...
    private BDDReader(BDDQueue q, BDDChunk chunk) { super();
                                                    this.q = q;
                                                    this.chunk = chunk; }
