...
public class PointtoTestDriver {
	...
	public static void main(String[] args) throws IOException { // wjtp.tn
		...
		String argsOfToyW = "-f J -pp -cp /home/lpxz/eclipse/workspace/leap/transformer/bin --app anode_opt_example.Example"; // java.lang.Math
