...
public class getDirectedGraph {
	...
	public static void main(String[] args) throws IOException { // wjtp.tn
		// @link LockProducer
		String secondClass = "example.URLParse";//"Drivers.LineNoTester";
		String secondMethod = "getVal";
		...
		String argsOfToyW = "-f J -pp -cp /home/lpxz/eclipse/workspace/simple/bin example.ExampleThread"; // java.lang.Math
