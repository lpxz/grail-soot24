...
public class MHPTransformerDriver {
	...
	// 	 Setup.setPhaseOptionsForPaddleWork();
		...
		wjtp.add(new Transform("wjtp.mhpcontainer", new SceneTransformer() {
			
			@Override
			protected void internalTransform(String phaseName, Map options) {
			  MhpTransformer.v().transform();
			  // many useful staffs, try to reuse the code
