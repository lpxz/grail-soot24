...
import soot.jimple.toolkits.visitor.jpaul.DataStructs.Relation;
import soot.jimple.toolkits.visitor.jpaul.DataStructs.MapSetRelation;
import soot.jimple.toolkits.visitor.jpaul.DataStructs.UnionFind;
import soot.jimple.toolkits.visitor.jpaul.DataStructs.DSUtil;
import soot.jimple.toolkits.visitor.jpaul.DataStructs.NonIterableSet;
import soot.jimple.toolkits.visitor.jpaul.DataStructs.NonIterableMap;

import soot.jimple.toolkits.visitor.jpaul.DataStructs.WorkSet;
import soot.jimple.toolkits.visitor.jpaul.DataStructs.WorkStack;
import soot.jimple.toolkits.visitor.jpaul.DataStructs.WorkPriorityQueue;
...
/**
   ...
   achieved by using a {@link soot.jimple.toolkits.visitor.jpaul.DataStructs.WorkPriorityQueue
 ...
 * @version $Id: ConstraintSystem.java,v 1.25 2006/03/14 02:29:28 salcianu Exp $ */
public class ConstraintSystem<V extends Var<Info>, Info> {
// info:value:hashset!!
	
	
    // Union-find structure to maintain the sets of equal variables
    public UnionFind<V> uf;// yes you can retreive it!!
    public DiGraph<V> reducedGraph=null;
    //after construction, you can have a look at what is in the reducedGraph
	...
	for(SCComponent<V> scc : ts_deps.decrOrder()) {
	    // To understand the processing done for each SCC,
	    // please read the comments in solveSCC below
	    solveSCC(scc);
	}
	...
	// (or do not read anyq arg. at all).  Still, we cannot be
	...
	// 2. Iterate over constraints that may may read (at least)
	// one var from scc and may write one or more variable(s) from
	// scc
