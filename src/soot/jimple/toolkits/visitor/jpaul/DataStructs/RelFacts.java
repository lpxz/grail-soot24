...
public abstract class RelFacts {
	...
	return new soot.jimple.toolkits.visitor.jpaul.DataStructs.MapSetRelationFactory<K,V>(mapFact, setFact);	
    }
    ...
    @Deprecated
	public static class MapSetRelationFactory<K,V> extends soot.jimple.toolkits.visitor.jpaul.DataStructs.MapSetRelationFactory<K,V> {
	...
	return new soot.jimple.toolkits.visitor.jpaul.DataStructs.COWRelationFactory<K,V>(underRelFact);
    }
    ...
    @Deprecated
	public static class COWRelationFactory<K,V> extends soot.jimple.toolkits.visitor.jpaul.DataStructs.COWRelationFactory<K,V> {
