...
package soot.jimple.toolkits.visitor.jpaul.DataStructs;
...
public final class SetFacts {
	...
	return new soot.jimple.toolkits.visitor.jpaul.DataStructs.COWSetFactory<E>(underSetFact);
    }
    ...
    @Deprecated
	public static class COWSetFactory<E> extends soot.jimple.toolkits.visitor.jpaul.DataStructs.COWSetFactory<E> {
