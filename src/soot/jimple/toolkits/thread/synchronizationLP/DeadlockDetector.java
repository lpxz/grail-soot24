...
//							!visibleOrder.containsEdge(existingLockNum, lockNumToInsert) ) // if(! existing before toinsert )
				...
				G.v().out.println("reordered from " + LockProducer.locksetToLockNumString(tn.lockset, lockToLockNum) +
								" to " + LockProducer.locksetToLockNumString(newLockset, lockToLockNum));
