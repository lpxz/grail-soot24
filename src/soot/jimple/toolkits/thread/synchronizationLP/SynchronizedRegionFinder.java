...
//	SideEffectAnalysis sea;
	...
	public boolean optionOpenNesting = true;// originally it is different from the conditino 
    ...
    protected void flowThrough(FlowSet in, Unit unit, FlowSet out)
    {
        ...
        while(outIt.hasNext())
        {
        	...
        	if(srfp.inside == true && (tn.nestLevel == nestLevel || optionOpenNesting == true))// let the internal tn be open to the outer tn!
        	{
