...
public class StrayRWFinder extends BackwardFlowAnalysis
{
    ...
    {
    	// body granularity, I dislike it
    	// to compare with all tns, if one conflicts, "I" need protection
    	// but this is not conservative actually.
    	// for example, two shared access to one variable may be both unprotected.
    	...
    	while(tnIt.hasNext())
    	{
    		...
    		if(stmtRead.hasNonEmptyIntersection(tn.write) || 
    			...
    			addSelf = Boolean.TRUE;// decision point: add or not
    	}
