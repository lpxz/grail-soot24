...
//	    if( ret == null ) ret = G.v().Union_factory.newUnion(); // may be null!!
//	    ret.addAll( os );
//	}
//	return ret;
//    }
    ...
    public PointsToSet getBaseForField( Object f ) {
    	...
    	for (RWSet s : sets) {
    	    ...
    	    if( os == null ) continue;
    	    if( os.isEmpty() ) continue;
    	    if(ret==null) ret =new HashPointsToSet(((PointsToSetInternal)os).getType(), (PAG) Scene.v().getPointsToAnalysis());
    	    ret.addAll( (PointsToSetInternal)os, null );
    	}
    	return ret;
        }
