...
{
	public static HashMap<Local, Local> cloned2orig = new HashMap<Local, Local>();
	public static Local getOriginal(Local cloned)
	{
		return cloned2orig.get(cloned);
	}
    ...
    public Map<Object, Object> importBodyContentsFrom(Body b)
    {
...

        {
	        ...
	        while(it.hasNext()) {
	            ...
	            bindings.put(original, copy);
	            Body.cloned2orig.put(copy, original);
	        }
        }
	...
	while(it.hasNext()) {
		...
		if(v instanceof Local) {
		    ...
		    if(!init.contains(l))
		    {
		    	  InitAnalysis analysis2=new InitAnalysis(g);
