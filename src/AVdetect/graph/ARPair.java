...
public class ARPair<T extends HardCriticalEvent, U extends HardCriticalEvent>
{
	 static int times =0;
    public ARPair( T o1, U o2 ) { this.o1 = o1; this.o2 = o2; }
    ...
    public boolean equals( Object other ) {
        if( other instanceof ARPair) {
            ARPair p = (ARPair) other;
